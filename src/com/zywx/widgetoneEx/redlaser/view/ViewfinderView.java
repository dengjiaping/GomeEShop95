...
package com.zywx.widgetoneEx.redlaser.view;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawRect(frame.right - 1, frame.top + 1, frame.right, frame.bottom - 1, paint);
            ...
            float den = MobileDeviceUtil.getInstance(context.getApplicationContext()).getScreenDensity();
            if (screenWidth <= 240) {
                textSize = 12;
            } else if (screenWidth <= 320 && screenWidth > 240) {
                textSize = 14;
            } else if (screenWidth <= 480 && screenWidth > 320) {
                textSize = 20;
            } else if (screenWidth <= 654 && screenWidth > 480) {
                textSize = 22;
            } else if (screenWidth > 654) {
                textSize = 24;
            }
            paint.setTextSize(textSize / den);
            // 画文字
            // canvas.drawText(context.getString(R.string.barcode_explain), frame.left+10, height-textSize-10, paint);
