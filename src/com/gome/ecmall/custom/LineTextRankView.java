...
public class LineTextRankView extends TextView {

    public LineTextRankView(Context context) {
        super(context);
    }

    public LineTextRankView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LineTextRankView(Context context, AttributeSet attrs, int defStyle) {
