...
public class TabSwitcher extends LinearLayout implements OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        float density = MobileDeviceUtil.getInstance(getContext().getApplicationContext().getApplicationContext()).getScreenDensity();
        ...
        for (int i = 0; i < length; i++) {
            ...
            btns[i].setTextColor(getResources().getColor(R.color.main_default_black_text_color));
            btns[i].setBackgroundResource(R.drawable.common_tabswitcher_item_selector);
