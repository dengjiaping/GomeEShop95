...
public class SearchHistoryDao {
    ...
    public void addSearchHistory(String keyWords) {
        ...
        try {
            ...
            String sql = "SELECT * FROM " + DBOpenHelper.TABLE_SEARCH_HISTORY + " where "
            ...
            if (!exist) {
                ...
                db.insert(DBOpenHelper.TABLE_SEARCH_HISTORY, null, cv);
            }
    ...
    public ArrayList<String> getSearchHistoryList(int size) {
        ...
        try {
            String sql = "SELECT * FROM " + DBOpenHelper.TABLE_SEARCH_HISTORY + " order by "
    ...
    public int removeAllHistory() {
        ...
        try {
            db = helper.getWritableDatabase();
            affectedRows = db.delete(DBOpenHelper.TABLE_SEARCH_HISTORY, null, new String[] {});
        } catch (SQLException e) {
    ...
    public boolean removeHistoryBykeyWords(String keyWords) {
        ...
        try {
            db = helper.getWritableDatabase();
            affectedRows = db.delete(DBOpenHelper.TABLE_SEARCH_HISTORY, DBOpenHelper.FILED_KEY_WORDS + " = ? ",
                    new String[] { keyWords });
            if (affectedRows > 0) {
                isdel = true;
            }
