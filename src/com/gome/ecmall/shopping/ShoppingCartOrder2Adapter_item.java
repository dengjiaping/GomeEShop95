 ...
 * 
 */
public class ShoppingCartOrder2Adapter_item extends BaseAdapter {
    ...
    public ShoppingCartOrder2Adapter_item(Context context, List<Goods> getGoodsList) {
    ...
    public ShoppingCartOrder2Adapter_item(Context context, List<Goods> getGoodsList, String outOfStock) {
        this.getGoodsList = getGoodsList;
        this.context = context;
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.shopping_cart2_order_section_item_item1, null);
