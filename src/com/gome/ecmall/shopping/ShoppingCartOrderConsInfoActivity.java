 ...
 * 
 */
public class ShoppingCartOrderConsInfoActivity extends Activity implements OnClickListener {
    ...
    private RelativeLayout cons_info_relativelayout, zope_relative, relative_list, consinfo_relative, save_relativve,
            selectrelative;
    private ShoppingCartOrderConsInfoAdapter shoppingConsInfoAdapter;
        ...
        case R.id.shopping_province_data: {
            if (provinceList == null) {
                ...
                for (int i = 0 , size = provinceList.size(); i < size; i++) {
                    if (provinceId != null && provinceId.equals(provinceList.get(i).getDivisionCode())) {
                        provinceIndex = i;
                        break;
                    }
                }
    ...
    private void initTitleButton() {
        ...
        common_title_btn_right.setText(R.string.shopping_goods_order_consinfo_add_newaddress);
    ...
    private void getDivision(final int divisionLevel, final String parentDivisionCode) {
        ...
        new AsyncTask<Object, Void, List<Division>>() {
            ...
            protected void onPreExecute() {
                progressDialog = CommonUtility.showLoadingDialog(ShoppingCartOrderConsInfoActivity.this,
            ...
            protected void onPostExecute(List<Division> divisionList) {
                ...
                if (divisionList == null) {
                    CommonUtility.showToast(ShoppingCartOrderConsInfoActivity.this,
                ...
                case province_type: {
                    ...
                    if (provinceList != null) {
                        ...
                        for (int i = 0, size = provinceList.size(); i < size; i++) {
                            ...
                            if (provinceId != null && provinceId.equals(division.getDivisionCode())) {
                                provinceIndex = i;
                            }
                        }
                    }
    ...
    private void initExpan() {
        if (!isExpan) {
            ...
            if (shoppingConsInfoAdapter != null) {
                ...
                shoppingConsInfoAdapter = new ShoppingCartOrderConsInfoAdapter(context, myRecentAddresslyList);
            ...
            new AsyncTask<Object, Void, Object[]>() {
                ...
                protected void onPostExecute(Object[] objs) {
                    ...
                    if (objs == null || (Boolean) objs[0] == null) {
                        CommonUtility.showMiddleToast(ShoppingCartOrderConsInfoActivity.this, "",
    ...
    private void saveOrModifyAddress() {
        ...
        if (isEmpty(context, cons_phone_data, getString(R.string.shopping_goods_order_consinfo_phone_null))) {
            return;
        ...
        if (GlobalConfig.getInstance().getGroupLimitType() == GroupLimitOrderActivity.GoodOrderType) {
            saveOrModifyAddressDataNormal(consInfoAddress);
        } else {
        ...
        new AsyncTask<Object, Void, Object[]>() {
            ...
            protected Object[] doInBackground(Object... params) {
                ...
                if (GlobalConfig.getInstance().getGroupLimitType() == GroupLimitOrderActivity.GroupType) {
                    result = NetUtility.sendHttpRequestByPost(Constants.URL_GROUPON_MODADDRESS, body);
                } else if (GlobalConfig.getInstance().getGroupLimitType() == GroupLimitOrderActivity.LimitType) {
                    result = NetUtility.sendHttpRequestByPost(Constants.URL_RUSHBUY_CHECKOUT_MOD_ADDRESS, body);
                } else if (GlobalConfig.getInstance().getGroupLimitType() == GroupLimitOrderActivity.GoodOrderType) {
                    result = NetUtility.sendHttpRequestByPost(Constants.URL_CHECKOUT_MOD_ADDRESS, body);
                }
                if (NetUtility.NO_CONN.equals(result)) {
                    return null;
                }
            ...
            protected void onPostExecute(Object[] objs) {
                ...
                if ((Boolean) objs[0]) {
                    Intent intent = new Intent(ShoppingCartOrderConsInfoActivity.this, ShoppingCartOrderActivity.class);
                    if (GlobalConfig.getInstance().getGroupLimitType() == GroupLimitOrderActivity.GroupType
                            || GlobalConfig.getInstance().getGroupLimitType() == GroupLimitOrderActivity.LimitType) {
                        setResult(11, intent); // 用一个新的标志是为了记录团购的地址是否选择，进而提示用户是否可以选择配送方式
                    } else {
                        setResult(0, intent);
                    }
                    finish();
     ...
     * @param consInfoAddress
     */
    private void saveOrModifyAddressDataNormal(final ShoppingCart_Recently_address consInfoAddress) {
        if (!NetUtility.isNetworkAvailable(context)) {
            CommonUtility.showMiddleToast(context, "",
                    context.getString(R.string.can_not_conntect_network_please_check_network_settings));
            return;
        ...
        new AsyncTask<Object, Void, Object[]>() {
            ...
            protected Object[] doInBackground(Object... params) {
                ...
                return ShoppingCart.paserResponseShoppingCart_Con_Save(result);
            };
            ...
            protected void onPostExecute(Object[] objs) {
                ...
                if ((Boolean) objs[0]) {
                    ...
                    CommonUtility.showMiddleToast(context, "", (String) objs[1]);
                } else if (!(Boolean) objs[0] && objs.length == 4) {
                    final String IsOutOfShipping = (String) objs[2];
                    @SuppressWarnings("unchecked")
                    final ArrayList<OutOfStockGoods> outOfShippingList = (ArrayList<OutOfStockGoods>) objs[3];

                    if (IsOutOfShipping.equalsIgnoreCase("Y")) {
                        if (outOfShippingList != null && outOfShippingList.size() > 0) {
                            ...
                            CommonUtility.showConfirmDialog(context,
                                    getString(R.string.shopping_goods_order_so_sorry_shipping), sb.toString(),
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            dialog.dismiss();
                                            Intent intent = new Intent();
                                            intent.putExtra("isOutOfShipping", IsOutOfShipping);
                                            intent.putExtra("outOfShippingList", outOfShippingList);
                                            intent.setClass(getApplicationContext(),
                                                    ShoppingCartOrderConsInfoActivity.class);
                                            setResult(8, intent);
                                            finish();
                                        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case 0:
            if (data != null) {
                ...
                if ("com.gome.ecmall.shopping.ShoppingCartConsInfoAddActivity".equals(action)) {
                    setResult(0, intent);
                    finish();
                }
            }
