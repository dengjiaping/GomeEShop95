...
public class ShoppingCartCouponRedTicketAdapter extends BaseAdapter {
    ...
    public ShoppingCartCouponRedTicketAdapter(Context context, List<RedTicketDetail> redTicketDetailList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.shopping_cart_conpon_redticket_item, null);
            ...
            if (redTicketDetail != null) {
                if (isChecked) {
                    if (!TextUtils.isEmpty(redTicketDetail.getRedTicketAmount())) {
                        ...
                        if ((redTotalAmount + Double
                                .parseDouble(((ShoppingCartCouponActivity) context).getBlueAcount())) >= orderPayTotalAmount
                                + couponAmount
                                && !initTotalCount) {
    ...
    public double getRedTotalAmount() {
