 ...
 * 
 */
public class ShoppingCartConsInfoAddActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initTitleButton();
        ShoppingCart_Recently_address currentAddress = (ShoppingCart_Recently_address) getIntent()
    ...
    public void onClick(View v) {
        ...
        case R.id.shopping_province_data: {
            if (provinceList == null) {
                ...
                CommonUtility.showSingleChioceDialog(ShoppingCartConsInfoAddActivity.this,
    ...
    private void saveOrModifyAddress() {
        ...
        if (ShoppingCartOrderConsInfoActivity.isEmpty(ShoppingCartConsInfoAddActivity.this, cons_name_data,
        ...
        if (!ShoppingCartOrderConsInfoActivity.isConsNameYes(cons_name_data)) {
            CommonUtility.showMiddleToast(ShoppingCartConsInfoAddActivity.this, "",
        ...
        if (ShoppingCartOrderConsInfoActivity.isEmpty(ShoppingCartConsInfoAddActivity.this, cons_phone_data,
        ...
        if (ShoppingCartOrderConsInfoActivity.isEmpty(ShoppingCartConsInfoAddActivity.this, cons_detailaddress_data,
    ...
    private void saveOrModifyAddressData(final ShoppingCart_Recently_address consInfoAddress) {
        if (!NetUtility.isNetworkAvailable(ShoppingCartConsInfoAddActivity.this)) {
            CommonUtility.showMiddleToast(ShoppingCartConsInfoAddActivity.this, "",
        ...
        new AsyncTask<Object, Void, Object[]>() {
            ...
            protected void onPreExecute() {
                progressDialog = CommonUtility.showLoadingDialog(ShoppingCartConsInfoAddActivity.this,
            ...
            protected void onPostExecute(Object[] objs) {
                ...
                if ((Boolean) objs[0]) {
                    Intent intent = new Intent(getApplicationContext(), ShoppingCartOrderConsInfoActivity.class);
                    intent.setAction("com.gome.ecmall.shopping.ShoppingCartConsInfoAddActivity");
                    if (GlobalConfig.getInstance().getGroupLimitType() == GroupLimitOrderActivity.GroupType
                    ...
                    CommonUtility.showAlertDialog(ShoppingCartConsInfoAddActivity.this, "", (String) objs[1],
        ...
        new AsyncTask<Object, Void, List<Division>>() {
            ...
            protected void onPostExecute(List<Division> divisionList) {
                ...
                if (divisionList == null) {
                    CommonUtility.showToast(ShoppingCartConsInfoAddActivity.this,
                            getString(R.string.data_load_fail_exception));
                    return;
                }
