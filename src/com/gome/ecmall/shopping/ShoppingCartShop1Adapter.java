...
public class ShoppingCartShop1Adapter extends BaseAdapter {
    ...
    public ShoppingCartShop1Adapter(Context context, List<Goods> shoppingCartGoodsList, ListView listView) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (goods != null) {
            ...
            if (goods.getGoodsMaxCount() != 0) {
                holder.shopping_cart_edit_number_data.setTag(R.string.finish, goods.getGoodsMaxCount());
            } else {
                holder.shopping_cart_edit_number_data.setTag(R.string.finish, 9999);
            }
            holder.shopping_cart_edit_number_data.setTag(R.string.second, goods);
            ...
            holder.shopping_cart_edit_number_data.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    ...
                    if (!TextUtils.isEmpty(s)) {
                        int totalNumber = (Integer) myEditText.getTag(R.string.finish);
                        ...
                        Goods goods = (Goods) myEditText.getTag(R.string.second);
                        goods.setEditNum(myEditText.getText().toString());
                    }
                }
            ...
            if ((!ShoppingCartActivity.isEdit && className.equals(ShoppingCartActivity.class.getName()))
                ...
                holder.shopping_delete_button.setOnClickListener(new MyOnClickListener(goods));
                ...
                holder.shopping_cart_decre.setOnClickListener(new MyOnClickListener(goods));
                holder.shopping_cart_cre.setOnClickListener(new MyOnClickListener(goods));
            }
            if (className.equals(ShoppingCartActivity.class.getName())) {
    ...
    private class MyOnClickListener implements OnClickListener {
        ...
        public MyOnClickListener(Goods goods) {
            this.goods = goods;
        ...
        public void onClick(View v) {
            ...
            case R.id.shopping_cart_decre: {
                ...
                goods.setEditNum(edit_number.getText().toString());
            }
                break;
            case R.id.shopping_cart_cre: {
                ViewHolder holder = (ViewHolder) v.getTag();
                EditText edit_number = (EditText) holder.shopping_cart_edit_number_data;
                int totalNumber = (Integer) edit_number.getTag(R.string.finish);
                if (TextUtils.isEmpty(edit_number.getText())) {
                    edit_number.setText(edit_number.getHint());
                }
                String editNumber = edit_number.getText().toString();
    ...
    public Map<String, Object> getModifyCommeIDNumberHashMap() {
        ...
        if (listView != null) {
            for (int i = 0, count = shoppingCartGoodsList.size(); i < count; i++) {
                if (shoppingCartGoodsList != null && shoppingCartGoodsList.size() != 0) {
                    Goods goods = shoppingCartGoodsList.get(i);

                    modifyCommeIDNumber.put(goods.getCommerceItemID(), goods.getEditNum());
                }
