 ...
 * 
 */
public class ShoppingCart2Adapter_item extends BaseAdapter {
    ...
    public ShoppingCart2Adapter_item(Context context, List<Goods> getGoodsList) {
    ...
    public ShoppingCart2Adapter_item(Context context, List<Goods> getGoodsList, String outOfStock) {
        this.getGoodsList = getGoodsList;
        this.context = context;
    ...
    public ShoppingCart2Adapter_item(Context context, List<Goods> getGoodsList, String outOfStock, String commerceItemID) {
        this.getGoodsList = getGoodsList;
        this.context = context;
        this.outOfStock = outOfStock;
        inflater = LayoutInflater.from(context);
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.shopping_cart2_section_item_item1, null);
            ...
            holder.fu_goods_linearlayout = (LinearLayout) convertView.findViewById(R.id.fu_goods_linearlayout);
        ...
        if (goods != null) {
            ...
            if (holder.fu_goods_linearlayout.getChildCount() != 0) {
                holder.fu_goods_linearlayout.removeAllViews();
            }
            // 附商品赠品
            ...
            if (giftGoodsList != null) {
                for (int i = 0, giftSize = giftGoodsList.size(); i < giftSize; i++) {
                    ...
                    holder.fu_goods_linearlayout.addView(goods_zengView);
                }
            }
            // 附商品优惠
            ...
            if (goodspromList != null) {
                for (int i = 0, goodsPromSize = goodspromList.size(); i < goodsPromSize; i++) {
                    ...
                    holder.fu_goods_linearlayout.addView(goods_promView);
                }
            }
        }
        return convertView;
    ...
    public static class ViewHolder {
        ...
        private LinearLayout fu_goods_linearlayout;
