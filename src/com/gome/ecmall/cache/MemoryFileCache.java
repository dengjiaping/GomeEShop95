...
/**
 * android.os.MemoryFile是对Linux ashmem(匿名共享内存 anonymous share memory)的简单封装. 读写MemoryFile相比读写文件系统可大幅提高I/O效率,
 * 所以MemoryFileCache被设计用来存储缓存数据
 * 
 * @author zhenyu.fang
 * @date 2012-5-18
 */
public class MemoryFileCache {
    ...
    public static int getRecommendMemoryFileSize(Context context) {
        /**
         * 实测不同分辨率机型单个App可用内存大小 mdpi(320*480):16MB hdpi(480*800;480*854):32MB xhdpi(540*960;640*960):48MB
         * xhdpi(720*1280):64MB
         */
