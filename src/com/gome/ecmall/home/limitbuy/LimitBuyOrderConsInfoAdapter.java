...
public class LimitBuyOrderConsInfoAdapter extends BaseAdapter {
    ...
    public LimitBuyOrderConsInfoAdapter(Context context, List<ShoppingCart_Recently_address> recentAddresslyList) {
        ...
        public void onClick(View v) {
            ...
            if (holder != null) {
                ...
                if (isChecked) {
                    ...
                    holder.shopping_order_consinfo_radiobutton_img.setTag(false);
                    ((LimitbuyConsInfoActivity) context).cleartSelectAddress();
                    addressId = "";
                    ...
                    ((LimitbuyConsInfoActivity) context).setSelectAddress(holder.rec_address);
    ...
    private OnLongClickListener onLongClickListener = new OnLongClickListener() {
        ...
        public boolean onLongClick(View v) {
            ...
            ViewHolder holder = (ViewHolder) v.getTag();
            ((LimitbuyConsInfoActivity) context).deleteAddress(holder.rec_address);
            return false;
        }
