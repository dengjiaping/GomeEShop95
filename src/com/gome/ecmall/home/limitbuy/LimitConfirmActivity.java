 ...
 * 
 */
public class LimitConfirmActivity extends Activity implements View.OnClickListener, TextWatcher {
    ...
    private void initTitleButton() {
        ...
        Goods goods = (Goods) getIntent().getSerializableExtra("limitgoods");
        if (goods != null) {
    ...
    private void setData() {
        if (!NetUtility.isNetworkAvailable(LimitConfirmActivity.this)) {
            return;
        }
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected void onPreExecute() {
                dialog = CommonUtility.showLoadingDialog(LimitConfirmActivity.this, getString(R.string.loading), true,
            ...
            protected void onPostExecute(Bitmap bm) {
                ...
                if (bm == null) {
                    CommonUtility.showMiddleToast(LimitConfirmActivity.this, null,
                            getString(R.string.get_verification_error));
                    return;
                } else {
                    BitmapDrawable bd = new BitmapDrawable(LimitConfirmActivity.this.getResources(), bm);
    ...
    private void submitOrder() {
        ...
        if (TextUtils.isEmpty(mCode)) {
            CommonUtility.showMiddleToast(LimitConfirmActivity.this, null, getString(R.string.login_input_code));
            return;
        }
        if (mCode != null && mCode.length() != 4) {
            CommonUtility.showMiddleToast(LimitConfirmActivity.this, null, getString(R.string.input_check_code_login));
            return;
        }
        new AsyncTask<Object, Void, OrderSuccess>() {
            ...
            protected void onPreExecute() {
                progressDialog = CommonUtility.showLoadingDialog(LimitConfirmActivity.this,
            ...
            protected OrderSuccess doInBackground(Object... params) {
                ...
                String mCode = codeEditText.getText().toString();
                String body = ShoppingCart.reqGroupLimtSubmitOrder(orderMark, mCode);
                String result = NetUtility.sendHttpRequestByPost(Constants.URL_RUSHBUY_CHECKOUT_SUBMIT_ORDER, body);
                // result =
            ...
            protected void onPostExecute(OrderSuccess orderSuccess) {
                ...
                if (orderSuccess == null) {
                    CommonUtility.showMiddleToast(LimitConfirmActivity.this, "", ShoppingCart.getErrorMessage());
                    setData();
                    return;
                }
                if (!TextUtils.isEmpty(orderSuccess.getOrderId())) {
                    ...
                    intent.setAction("LimitConfirmActivity");
