...
public class MyCouponListAdapter extends BaseAdapter {
    ...
    public MyCouponListAdapter(Context ctx, ArrayList<Coupon> coupons, String type) {
        mContext = ctx;
        this.type = type;
