...
public class RedCouponListAdapter extends BaseAdapter {
    private ArrayList<Coupon> list = new ArrayList<Coupon>();
    private LayoutInflater mInflater;
    private Context mContext;
    private float density;

    public RedCouponListAdapter(Context ctx, ArrayList<Coupon> coupons) {
        mContext = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.ivLogo.setImageResource(R.drawable.product_red_coupon_icon);
