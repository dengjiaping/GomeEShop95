...
import com.gome.ecmall.custom.SuiteFilterFilterDialog;
...
/**
 * 套购列表筛选页 来源为SuiteBuyActivity类似结构 如修改，两处都对等修改 对应的筛选对话框为SuiteFilterFilterDialog
 */
public class SuiteBuyFilterActivity extends AbsSubActivity implements OnClickListener, OnPageChangeListener {
    private static final String TAG = "SuiteBuyActivity";
    private Button mBackBtn;
    private TextView mTitleText;
    private Button mFilterBtn;
    private LayoutInflater mInflater;
    private SuiteFilterFilterDialog filterDialog = null;
    private VerticalViewPager mViewPager;
    private SuiteBuyAdapter mAdapter;
    private ArrayList<SuiteBuyFilter> filterList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectIndex = getIntent().getStringExtra(INTENT_KEY_SELECT_INDEX);
        filterList = (ArrayList<SuiteBuyFilter>) getIntent().getSerializableExtra(INTENT_KEY_FILTER_LIST);
        initView();
        reload(mSelectIndex);
    }
    ...
    protected void onResume() {
        ...
        super.onResume();
        AppMeasurementUtils appMeasurementProm = new AppMeasurementUtils(SuiteBuyFilterActivity.this);
    ...
    private void initView() {
        ...
        for (int i = 0, size = filterList.size(); i < size; i++) {
            if (filterList.get(i).isSelected()) {
                mTitleText.setText(filterList.get(i).getSelectIndexName());
                break;
            }
        }
    ...
    private class LoadTask extends AsyncTask<Void, Void, SuiteBuy> {
        ...
        protected void onPostExecute(SuiteBuy result) {
            ...
            mAdapter = new SuiteBuyAdapter(SuiteBuyFilterActivity.this, suiteList);
            mViewPager.setAdapter(mAdapter);
            mViewPager.setOnPageChangeListener(SuiteBuyFilterActivity.this);
        }
    ...
    private boolean isNetConn() {
        if (!NetUtility.isNetworkAvailable(SuiteBuyFilterActivity.this)) {
            CommonUtility.showMiddleToast(SuiteBuyFilterActivity.this, null,
                    SuiteBuyFilterActivity.this.getString(R.string.data_load_fail_please_check_network_settings));
            return false;
    ...
    private void loadMore(final int currPage, final int pageSize, final String index) {
        ...
        asyncTask = new AsyncTask<Void, Void, SuiteBuy>() {
            ...
            protected void onPostExecute(SuiteBuy result) {
                ...
                if (result == null) {
                    CommonUtility.showMiddleToast(SuiteBuyFilterActivity.this, "",
    ...
    private void showFilterDialog() {
        filterDialog = SuiteFilterFilterDialog.show(SuiteBuyFilterActivity.this, filterList);
        filterDialog.setActivity(SuiteBuyFilterActivity.this);
