...
public class ModifyGroupBuyMobileActivity extends Activity implements OnClickListener {// ,OnEditorActionListener
    ...
    private EditText newMobileNumET;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.modify_group_buy_mobile);
        initView();
    ...
    private void initView() {
        ...
        mTitle.setText(R.string.new_groupbuy_buy_modify_mobile);

        mobileNumET = (EditText) findViewById(R.id.modify_payment_password_mobile);
        newMobileNumET = (EditText) findViewById(R.id.modify_new_mobile);
    ...
    public boolean connected() {
        boolean conn = NetUtility.isNetworkAvailable(ModifyGroupBuyMobileActivity.this);
        if (!conn) {
            CommonUtility.showMiddleToast(ModifyGroupBuyMobileActivity.this, null,
    ...
    public void onClick(View v) {
        ...
        case R.id.next_button:
            ...
            newMobileNum = newMobileNumET.getText().toString().trim();
            if ("".equals(mobileNum)) {
            ...
            if ("".equals(newMobileNum)) {
                toast(getString(R.string.login_input_new_mobile));
                return;
            } else if (!RegisterActivity.isMobile(newMobileNum)) {
                toast(getString(R.string.login_input_right_new_mobile));
                return;
            }
            activeAccount();
            break;
    ...
    private void activeAccount() {
        if (!NetUtility.isNetworkAvailable(ModifyGroupBuyMobileActivity.this)) {
        ...
        new AsyncTask<Void, Void, GetActivateCode>() {
            ...
            protected void onPreExecute() {
                ...
                dialog = CommonUtility.showLoadingDialog(ModifyGroupBuyMobileActivity.this,
            ...
            protected GetActivateCode doInBackground(Void... params) {
                String request = Register.createActivateGroupMobile(SetGroupBuyMobileActivity.OPERATE_TYPE_MOD, mobileNum,checkCodeET.getText().toString(),newMobileNum);
                String response = null;
                if (!applcation.isSupportedHttps) {
                    try {
                        HttpsUtils.initKey(ModifyGroupBuyMobileActivity.this.getAssets());
            ...
            protected void onPostExecute(GetActivateCode result) {
                ...
                if (JsonInterface.JV_YES.equalsIgnoreCase(result.getIsSuccess())) {
                    ...
                    intent.putExtra("mobileNum", newMobileNum);
    ...
    void toast(String message) {
        ...
        CommonUtility.showMiddleToast(ModifyGroupBuyMobileActivity.this, null, message);
    }
